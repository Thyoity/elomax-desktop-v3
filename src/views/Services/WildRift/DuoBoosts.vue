<template>
  <div class="services--container my-services">
    ...
    <div v-if="!isLoadingServices" class="page-content">
      ...
      <OverlayScrollbar v-if=" inProgressWildRiftDuoBoosts && inProgressWildRiftDuoBoosts.length> 0
        "
        style="height: calc(100% - 100px)"
      >
        <div class="service-list">
          <div
            v-for="service in inProgressWildRiftDuoBoosts"
            :key="service.id"
          ...
          >
            ...
            >
              ...
              <h5 class="play-time" v-if="service.details.play_time" style="margin-top: 0;" v-tippy="{ placement: 'right', arrow: true }" :content="service.details.play_time">Horário: <span class="description-icon" style="margin-left: 3px;" >
...
export default {
  ...
  computed: {
    ...
    ...mapState(useServicesStore, ["inProgressWildRiftDuoBoosts"]),
  },
  methods: {
