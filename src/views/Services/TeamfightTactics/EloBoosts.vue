<template>
  <div class="services--container my-services">
    ...
    <div v-if="!isLoadingServices" class="page-content">
      ...
      <OverlayScrollbar v-if=" inProgressTftEloBoosts && inProgressTftEloBoosts.length> 0
        "
        style="height: calc(100% - 100px)"
      >
        <div class="service-list">
          <div
            v-for="service in inProgressTftEloBoosts"
            :key="service.id"
...
export default {
  ...
  computed: {
    ...
    ...mapState(useServicesStore, ["inProgressTftEloBoosts"]),
  },
  methods: {
