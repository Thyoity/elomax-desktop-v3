    ...
    <div class="page-content">
      ...
      >
        <h3 class="animated fadeIn page-header-menu">
          <a href="javascript:void(0)" @click="$router.push('/blog-articles')">
            <ion-icon
...
export default {
  ...
  data() {
    return {
      ...
      editor: InlineEditor,
      editorConfig: {
        placeholder: "Comece escrevendo o seu artigo aqui",
        plugins: [
          EssentialsPlugin,
          HeadingPlugin,
          BoldPlugin,
    ...
    async save() {
      ...
      try {
        const { data } = await axios.post(
          `https://elojobmax.com.br/api/user/blog-articles/create/form-data`,
          formData,
          {
            headers: {
        ...
        this.$toast.success('Artigo criado!', 'Sucesso', {
          position: "topCenter"
        })
